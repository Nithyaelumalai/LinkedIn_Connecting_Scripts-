...
public class SeleniumHelper {
    ...
    public WebElement waitForVisibilityOf(By elementId) {
        return new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.elementToBeClickable(elementId));
    }

    public List<WebElement> waitUntilAllElementsLocatedOf(By elementId) {
        return new WebDriverWait(driver, Duration.ofSeconds(30)).until(ExpectedConditions.presenceOfAllElementsLocatedBy(elementId));
    }
